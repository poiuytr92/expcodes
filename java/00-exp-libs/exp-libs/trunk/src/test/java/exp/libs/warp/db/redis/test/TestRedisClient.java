...
public class TestRedisClient {
	...
	public static void main(String[] args) {
		...
		// 场景1  -  Redis 单机模式
		// 192.168.177.131:6379
		RedisClient redis = new RedisClient("192.168.177.131", 6379);
		
		// 场景2  -  Redis 主从模式 
		// （若用于[读写]只能连接主机，若仅[读]则可连接主/从，但无论如何只能连接其中一台）
		// 主机： 192.168.177.131:6379
		// 从机： 192.168.177.131:6380, 192.168.177.131:6381, 192.168.177.131:6382
		redis = new RedisClient("192.168.177.131", 6379);
		
		// 场景3  -  Redis 哨兵模式 
		// （若用于[读写]只能连接主机，若仅[读]则可连接主/从，但无论如何只能连接其中一台，哨兵不允许连接）
		// 主机： 192.168.177.131:6379
		// 从机： 192.168.177.131:6380, 192.168.177.131:6381, 192.168.177.131:6382
		// 哨兵： 192.168.177.131:26380, 192.168.177.131:26381, 192.168.177.131:26382
		redis = new RedisClient("192.168.177.131", 6379);
				
		// 场景4  -  Redis 集群模式 
		// 集群节点（需同时连接所有节点）：
		//   192.168.177.131:6390, 192.168.177.131:6391, 192.168.177.131:6392
		//   192.168.177.131:6393, 192.168.177.131:6394, 192.168.177.131:6395
		redis = new RedisClient(
				"192.168.177.131:6390", "192.168.177.131:6391", 
				"192.168.177.131:6392", "192.168.177.131:6393", 
				"192.168.177.131:6394", "192.168.177.131:6395"
		);
