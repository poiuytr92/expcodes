 ...
 * @since     jdk版本：jdk1.6
 */
public class Table<T> extends JTable implements MouseMotionListener, MouseListener {
	...
	public Table(Vector<T> header, Vector<Vector<T>> datas) {
		super(new DefaultTableModel(datas, header));	// 构造表单JTable
	...
	public void mouseMoved(MouseEvent e) {
		...
		this.repaint();	// 单元格重绘，目的是激活getTableCellRendererComponent方法
	}
	...
	public void mouseExited(MouseEvent e) {
		currentMouseRow = -1;	//设置悬浮行为-1(使得可以还原悬浮行原本的颜色)
		this.repaint();			//单元格重绘
	}
