...
| &nbsp; | &nbsp; | [`BellmanFord`](https://github.com/lyy289065406/expcodes/tree/master/java/00-exp-libs/exp-libs/trunk/src/main/java/exp/libs/algorithm/spa/BellmanFord.java) | （未实装）适用单源最短路问题<br/>时间复杂度：O(V \* E)<br/>空间复杂度：O(V + E) | &nbsp; |
| &nbsp; | &nbsp; | [`SPFA`](https://github.com/lyy289065406/expcodes/tree/master/java/00-exp-libs/exp-libs/trunk/src/main/java/exp/libs/algorithm/spa/SPFA.java) | （未实装）BellmanFord的优化版<br/>时间复杂度：O(k \* E)<br/>空间复杂度：O(V + E) | &nbsp; |
...
| &nbsp; | &nbsp; | [`Floyd`](https://github.com/lyy289065406/expcodes/tree/master/java/00-exp-libs/exp-libs/trunk/src/main/java/exp/libs/algorithm/spa/Floyd.java) | （未实装）适用全源最短路问题<br/>时间复杂度：O(V^3)<br/>空间复杂度：O(V^2) | &nbsp; |
...
| &nbsp; | &nbsp; | [`qaca`](https://github.com/lyy289065406/expcodes/tree/master/java/00-exp-libs/exp-libs/trunk/src/main/java/exp/libs/algorithm/heuristic/qaca) | 量子蚁群算法（引入量子环境改进的<br/>蚁群算法：量子比特、量子概率幅、量子<br/>态、量子旋转门等） | &nbsp; |
