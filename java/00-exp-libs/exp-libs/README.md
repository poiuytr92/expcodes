...
| &nbsp; | &nbsp; | HTTP/HTTPS组件<br/>[`http`](https://github.com/lyy289065406/expcodes/tree/master/java/00-exp-libs/exp-libs/trunk/src/main/java/exp/libs/warp/net/http) | 基于java.net.HttpURLConnection(JDK1.6+)与commons-httpclient(3.1-rc1)封装，借助org.bouncycastle.bcprov-jdk15on(1.54)使得可以在JDK1.6+环境均支持HTTP/HTTPS协议 | &nbsp; |
