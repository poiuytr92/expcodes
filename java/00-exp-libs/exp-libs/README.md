...
| &nbsp; | OCR图文识别<br/>[`ocr`](https://github.com/lyy289065406/expcodes/tree/master/java/00-exp-libs/exp-libs/trunk/src/main/java/exp/libs/warp/ocr) | &nbsp; | 基于`com.sun.media.jai-imageio(1.1-alpha)`<br/>封装，可识别图片中打印体的文字。（文字不<br/>能变形、旋转，越正规的文字识别率越高） | &nbsp; |
