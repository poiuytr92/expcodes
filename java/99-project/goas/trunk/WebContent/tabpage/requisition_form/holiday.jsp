...
<head>
    ...
    <script type="text/javascript" charset="utf-8">
    	$(function () {
    		$("#holiday-form").validationEngine();
    		
    		// submit button
    		$("#inp-btn").click( function (){
    			if( $('#holiday-form').validationEngine('validate') ) {
    				$.ajax({
...
<body>
    <div id="form">
      <form name="holidayForm" id="holiday-form">
    	<div id='head'>
    	...
    	<div class="field">
    		...
    		<div class="field-con">
    			<span>审批部门：</span>
    			<input name="name" type="text" id="inp-dept" class='inp' value='<%=session.getAttribute("dept")%>' disabled="disabled"/>
    		</div>
    		<div class="field-con">
    			<span>原 因：</span>
       	...
       	<!-- timing -->
       	<div class="field">
    		<div class="field-head">请假时间段</div>
    		<div class="field-con">
    			<span>开始时间：</span>
