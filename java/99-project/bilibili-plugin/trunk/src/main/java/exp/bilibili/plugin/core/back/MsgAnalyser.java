...
import exp.bilibili.protocol.bean.wsjson.ActivityEvent;
import exp.bilibili.protocol.bean.wsjson.ChatMsg;
import exp.bilibili.protocol.bean.wsjson.EnergyLottery;
import exp.bilibili.protocol.bean.wsjson.GuardBuy;
import exp.bilibili.protocol.bean.wsjson.GuardMsg;
import exp.bilibili.protocol.bean.wsjson.LiveMsg;
import exp.bilibili.protocol.bean.wsjson.Preparing;
import exp.bilibili.protocol.bean.wsjson.RaffleEnd;
import exp.bilibili.protocol.bean.wsjson.RaffleStart;
import exp.bilibili.protocol.bean.wsjson.SendGift;
import exp.bilibili.protocol.bean.wsjson.SpecialGift;
import exp.bilibili.protocol.bean.wsjson.SysGift;
import exp.bilibili.protocol.bean.wsjson.SysMsg;
import exp.bilibili.protocol.bean.wsjson.TvLottery;
import exp.bilibili.protocol.bean.wsjson.WelcomeGuard;
import exp.bilibili.protocol.bean.wsjson.WelcomeMsg;
import exp.bilibili.protocol.bean.wsjson.WishBottle;
