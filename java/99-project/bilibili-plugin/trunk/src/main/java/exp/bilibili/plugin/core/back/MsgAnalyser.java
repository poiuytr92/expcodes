...
import exp.bilibili.protocol.bean.ActivityEvent;
import exp.bilibili.protocol.bean.ChatMsg;
import exp.bilibili.protocol.bean.EnergyLottery;
import exp.bilibili.protocol.bean.GuardBuy;
import exp.bilibili.protocol.bean.GuardMsg;
import exp.bilibili.protocol.bean.LiveMsg;
import exp.bilibili.protocol.bean.Preparing;
import exp.bilibili.protocol.bean.RaffleEnd;
import exp.bilibili.protocol.bean.RaffleStart;
import exp.bilibili.protocol.bean.SendGift;
import exp.bilibili.protocol.bean.SpecialGift;
import exp.bilibili.protocol.bean.SysGift;
import exp.bilibili.protocol.bean.SysMsg;
import exp.bilibili.protocol.bean.TvLottery;
import exp.bilibili.protocol.bean.WelcomeGuard;
import exp.bilibili.protocol.bean.WelcomeMsg;
import exp.bilibili.protocol.bean.WishBottle;
