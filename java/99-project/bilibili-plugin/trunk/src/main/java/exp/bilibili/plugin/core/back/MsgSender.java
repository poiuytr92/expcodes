...
//			{"code":0,"data":"https://passport.biligame.com/crossDomain?DedeUserID=31796320&DedeUserID__ckMd5=7a2868581681a219&Expires=2592000&SESSDATA=b21f4571%2C1517901333%2Cba70690c&bili_jct=7136e7aefb2385048cd77cc93ce25d56&gourl=https%3A%2F%2Fwww.bilibili.com"}
	 ...
	 * @return
	 */
	public static List<String> queryTopLiveRoomIds(String cookies, 
	 ...
	 * @return
	 */
	private static List<String> _analyseTopLiveResponse(
		...
		try {
			...
			for(int i = 0 ; i < data.size(); i++) {
				...
				String realRoomId = JsonUtils.getStr(room, BiliCmdAtrbt.roomid);
				...
				String roomId = (shortId > 0 ? String.valueOf(shortId) : realRoomId);
	 ...
	 * @return
	 */
	private static List<String> _getStormIds(String roomId, String response) {
	 ...
	 * @return
	 */
	private static int _joinStorms(String roomId, List<String> raffleIds) {
		int cnt = 0;
		if(raffleIds.size() > 0) {
	 ...
	 * @return
	 */
	public static boolean toStormLottery(String roomId, String raffleId) {
		boolean isOk = true;
