...
public class Protocol {
	...
	public static boolean toAssn() {
		HttpCookie cookie = HttpCookies.INSTN().MAIN();	// FIXME 仅主号签到有爱社?
	...
	public static List<Integer> queryTopLiveRoomIds(
		...
		HttpCookie cookie = HttpCookies.INSTN().VEST();	// 使用马甲号扫描
	...
	public static String queryRedbagPool() {
		HttpCookie cookie = HttpCookies.INSTN().MAIN();	// FIXME 仅主号
