...
public class ActivityMgr {
	...
	public void save() {
		...
		log.info("更新直播�? [{}] 的活跃值{}", ROOM_ID, (isOk ? "成功" : "失败"));
	...
	private boolean _saveAll(List<TActivity> activitys) {
		...
		try {
			...
			log.error("更新直播�? [{}] 的活跃值异�?", ROOM_ID, e);
			isOk = false;
		}
