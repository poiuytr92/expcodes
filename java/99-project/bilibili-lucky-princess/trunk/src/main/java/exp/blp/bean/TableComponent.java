 ...
 * 用于创建表单组件，并配置其效果
 */
public class TableComponent extends JTable implements MouseMotionListener, MouseListener {
	...
	public TableComponent(Vector<String> header, Vector<Vector<String>> datas) {
	...
	public void mouseMoved(MouseEvent e) {
		...
		for(int r = 0; r < TableLength; r++) {
			if(r == currentMouseRow){
				TableComponent.this.setBackground(Color.green);
				break;
			}
		}
