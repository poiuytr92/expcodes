package exp.dubbo.consumer._demo.web.ctrl;
...
import exp.dubbo.consumer._demo.Config;

/**
 * 基于Simple-URL方式配置的Controller
 * 此demo与 spring-url.xml 配置文件配套
 */
public class SimpleUrlController implements Controller {
	
	private final static Logger log = LoggerFactory.getLogger(SimpleUrlController.class);
	...
	public ModelAndView handleRequest(
    	...
    	// 在本例中会根据spring-url.xml的视图解析器viewResolver的配置跳转到 
    	//   /WEB/INF/pages/demo-mvc-response.jsp页面
    	mv.setViewName("demo-mvc-response");
    	
    	// 添加模型数据 可以是任意的POJO对象
		mv.addObject("message", "This is a SimpleUrlController");
