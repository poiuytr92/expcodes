...
public class Course implements org.apache.thrift.TBase<Course, Course._Fields>, java.io.Serializable, Cloneable, Comparable<Course> {
  ...
  private static final org.apache.thrift.protocol.TField STUDENT_FIELD_DESC = new org.apache.thrift.protocol.TField("student", org.apache.thrift.protocol.TType.STRUCT, (short)2);
  private static final org.apache.thrift.protocol.TField STUDENTS_FIELD_DESC = new org.apache.thrift.protocol.TField("students", org.apache.thrift.protocol.TType.LIST, (short)3);
  ...
  public Person student; // required
  ...
  public Course(Course other) {
    ...
    if (other.isSetStudent()) {
      this.student = new Person(other.student);
    }
    if (other.isSetStudents()) {
      List<Person> __this__students = new ArrayList<Person>(other.students.size());
  ...
  public Course setStudent(Person student) {
    this.student = student;
    return this;
  }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.students = new ArrayList<Person>(_list0.size);
                Person _elem1;
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, Course struct) throws org.apache.thrift.TException {
      ...
      if (struct.students != null) {
        oprot.writeFieldBegin(STUDENTS_FIELD_DESC);
        {
          ...
          for (Person _iter3 : struct.students)
          {
            _iter3.write(oprot);
          }
          oprot.writeListEnd();
      ...
      if (struct.isSetStudents()) {
        {
          ...
          for (Person _iter4 : struct.students)
          {
            _iter4.write(oprot);
          }
        }
      ...
      if (incoming.get(2)) {
        {
          ...
          struct.students = new ArrayList<Person>(_list5.size);
          Person _elem6;
