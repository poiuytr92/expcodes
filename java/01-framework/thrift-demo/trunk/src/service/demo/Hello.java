...
public class Hello {
  ...
  public interface Iface {
    ...
    public Person getPerson(int id, String name) throws org.apache.thrift.TException;

    public Course getCourse(int id) throws org.apache.thrift.TException;
  ...
  public interface AsyncIface {
    ...
    public void getPerson(int id, String name, org.apache.thrift.async.AsyncMethodCallback resultHandler) throws org.apache.thrift.TException;

    public void getCourse(int id, org.apache.thrift.async.AsyncMethodCallback resultHandler) throws org.apache.thrift.TException;
  ...
  public static class Client extends org.apache.thrift.TServiceClient implements Iface {
    ...
    public Person getPerson(int id, String name) throws org.apache.thrift.TException
    {
      send_getPerson(id, name);
      return recv_getPerson();
    }

    public void send_getPerson(int id, String name) throws org.apache.thrift.TException
    {
    ...
    public void send_getCourse(int id) throws org.apache.thrift.TException
    {
    ...
    public Course recv_getCourse() throws org.apache.thrift.TException
    {
  ...
  public static class AsyncClient extends org.apache.thrift.async.TAsyncClient implements AsyncIface {
    ...
    public void getPerson(int id, String name, org.apache.thrift.async.AsyncMethodCallback resultHandler) throws org.apache.thrift.TException {
      checkReady();
      getPerson_call method_call = new getPerson_call(id, name, resultHandler, this, ___protocolFactory, ___transport);
      this.___currentMethod = method_call;
      ___manager.call(method_call);
    }
    ...
    public static class getPerson_call extends org.apache.thrift.async.TAsyncMethodCall {
      private int id;
      private String name;
      public getPerson_call(int id, String name, org.apache.thrift.async.AsyncMethodCallback resultHandler, org.apache.thrift.async.TAsyncClient client, org.apache.thrift.protocol.TProtocolFactory protocolFactory, org.apache.thrift.transport.TNonblockingTransport transport) throws org.apache.thrift.TException {
        super(client, protocolFactory, transport, resultHandler, false);
        this.id = id;
        this.name = name;
      }
    ...
    public void getCourse(int id, org.apache.thrift.async.AsyncMethodCallback resultHandler) throws org.apache.thrift.TException {
      checkReady();
      getCourse_call method_call = new getCourse_call(id, resultHandler, this, ___protocolFactory, ___transport);
      this.___currentMethod = method_call;
      ___manager.call(method_call);
    }
    ...
    public static class getCourse_call extends org.apache.thrift.async.TAsyncMethodCall {
      private int id;
      public getCourse_call(int id, org.apache.thrift.async.AsyncMethodCallback resultHandler, org.apache.thrift.async.TAsyncClient client, org.apache.thrift.protocol.TProtocolFactory protocolFactory, org.apache.thrift.transport.TNonblockingTransport transport) throws org.apache.thrift.TException {
        super(client, protocolFactory, transport, resultHandler, false);
        this.id = id;
      }
      ...
      public Course getResult() throws org.apache.thrift.TException {
        if (getState() != org.apache.thrift.async.TAsyncMethodCall.State.RESPONSE_READ) {
          throw new IllegalStateException("Method call not finished!");
        }
        org.apache.thrift.transport.TMemoryInputTransport memoryTransport = new org.apache.thrift.transport.TMemoryInputTransport(getFrameBuffer().array());
  ...
  public static class Processor<I extends Iface> extends org.apache.thrift.TBaseProcessor<I> implements org.apache.thrift.TProcessor {
    ...
    public static class getPerson<I extends Iface> extends org.apache.thrift.ProcessFunction<I, getPerson_args> {
      ...
      public getPerson_result getResult(I iface, getPerson_args args) throws org.apache.thrift.TException {
        getPerson_result result = new getPerson_result();
        result.success = iface.getPerson(args.id, args.name);
        return result;
      }
    }
    ...
    public static class getCourse<I extends Iface> extends org.apache.thrift.ProcessFunction<I, getCourse_args> {
      ...
      public getCourse_result getResult(I iface, getCourse_args args) throws org.apache.thrift.TException {
        getCourse_result result = new getCourse_result();
        result.success = iface.getCourse(args.id);
        return result;
      }
    }
  ...
  public static class AsyncProcessor<I extends AsyncIface> extends org.apache.thrift.TBaseAsyncProcessor<I> {
    ...
    public static class getPerson<I extends AsyncIface> extends org.apache.thrift.AsyncProcessFunction<I, getPerson_args, Person> {
      ...
      public void start(I iface, getPerson_args args, org.apache.thrift.async.AsyncMethodCallback<Person> resultHandler) throws TException {
        iface.getPerson(args.id, args.name,resultHandler);
      }
    }
    ...
    public static class getCourse<I extends AsyncIface> extends org.apache.thrift.AsyncProcessFunction<I, getCourse_args, Course> {
      ...
      public AsyncMethodCallback<Course> getResultHandler(final AsyncFrameBuffer fb, final int seqid) {
        final org.apache.thrift.AsyncProcessFunction fcall = this;
        return new AsyncMethodCallback<Course>() { 
      ...
      public void start(I iface, getCourse_args args, org.apache.thrift.async.AsyncMethodCallback<Course> resultHandler) throws TException {
        iface.getCourse(args.id,resultHandler);
      }
    }
...
;
  ...
  public static class getCourse_args implements org.apache.thrift.TBase<getCourse_args, getCourse_args._Fields>, java.io.Serializable, Cloneable, Comparable<getCourse_args>   {
    ...
    public getCourse_args setId(int id) {
      this.id = id;
      setIdIsSet(true);
      return this;
    }
