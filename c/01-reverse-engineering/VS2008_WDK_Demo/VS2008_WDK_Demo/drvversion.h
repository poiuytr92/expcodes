...
#define DRV_YEAR               2017 // current year or timespan (e.g. 2003-2009)
...
#define TEXT_MODULE            VS2008_WDK_Demo // module name
...
#define TEXT_INTERNALNAME      VS2008_WDK_Demo.sys // copyright information
